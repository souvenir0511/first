...
public class V2PolicyMongoToEsMain {
    private static final Logger logger = LoggerFactory.getLogger(V2PolicyMongoToEsMain.class);
    ...
    public static void fixEnterpriseData(String esName) throws Exception {
        ...
        while (++times < batchSize)
        {
            try
            {
                ...
                List<V2Policy> list = Lists.newArrayList();

                for(Document document : documents ) {
                    V2Policy policy = DocumentToBeanUtil.docToV2Policy(document);
                    list.add(policy);
                }
    ...
    public static void processor(List<V2Policy> policys, String esName) throws Exception{
