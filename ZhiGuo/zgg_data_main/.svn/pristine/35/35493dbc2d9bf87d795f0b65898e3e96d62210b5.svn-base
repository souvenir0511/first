 ...
 */
@Slf4j
public class SpiderMongoToMongoMysqlForTown {
    ...
    static String toMongoDatabaseName = "town";
    static String toMongoCollectionName = "enterprise";

    static String driver = "com.mysql.cj.jdbc.Driver";
    static String url="jdbc:mysql://192.168.10.154:3306/town_20211116?useUnicode=true&characterEncoding=UTF-8&serverTimezone=Asia/Shanghai&autoReconnect=true&failOverReadOnly=false&rewriteBatchedStatements=true";
...
//                });
    ...
    public static void entCopyRightProcessor(List<EntCopyRight> entCopyRightList) {
        ...
        String placeholder = "?,?,?,?,?,?,?,?,?";
        //sql
        String sql = "insert into `ent_productcopyright`(" + field + ")values(" + placeholder + ")";
        List<Object[]> objectsList = new ArrayList<>();
